...
@Component({
  selector: 'app-shipped-success-detail',
  templateUrl: './shipped-success-detail.component.html',
  styleUrls: ['./shipped-success-detail.component.css']
})
export class ShippedSuccessDetailComponent implements OnInit {
  public id;
  public imgUrl = '';
